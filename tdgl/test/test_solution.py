...
def test_dynamics(solution: tdgl.Solution):
    ...
    _ = DynamicsData.from_solution(solution.path, probe_points=None, progress_bar=False)
    _ = DynamicsData.from_solution(
        solution.path, probe_points=solution.device.probe_points, progress_bar=True
    )
